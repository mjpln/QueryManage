...
<html>
  <head>
	...
	<script type="text/javascript" src="./js/wordpatcity.js"></script>
  ...
  <body >
    <div >
    <span style="margin:10px 10px 10px 0px">简单词模:</span><input id="wordpat" type="text" readonly="readonly" editable="false" class="easyui-textbox" style="width:300px;"/><br/><br/>
