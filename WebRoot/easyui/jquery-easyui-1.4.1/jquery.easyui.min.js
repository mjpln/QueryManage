...
/*****
*把setTimeout改为setInterval
*解决combobox延时搜索使用输入法输入时无法触发keyHandler/query事件
*****/
_8eb.timer=setTimeout(function(){
//_8eb.timer=setInterval(function(){
...
/**
 * 修改 “{inputEvents:{click:_8e5,keydown:_” 为 “{inputEvents:{click:_8e5,keyup:_”。把keydown改为keyup
 */
...
_92d(_92a,_92c);
/**
 * 修复combobox全文本输入时不触发onSelect事件。注释下面一行
 */
...
if(row){
/**
 * 修复combobox全文本输入时不触发onSelect事件。具体：添加下面5行
 */
//opts.onSelect.call(_933, opts.finder.getRow(_933, v));
s=row[opts.textField];
// start
var el=opts.finder.getEl(_933,v);
if(!el.hasClass("combobox-item-selected")){
el.addClass("combobox-item-selected");
opts.onSelect.call(_933,row);
}
// end
}
vv.push(v);
