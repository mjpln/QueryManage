...
public class RandomCodeUtils {
	...
	public static String generateRandomCode(int verifySize) {
		return generateRandomCode(verifySize, VERIFY_CODES);
	}
	...
	public static String outputVerifyImage(int w, int h, File outputFile,
		...
		String verifyCode = generateRandomCode(verifySize);
	...
	public static void main(String[] args) throws IOException {
		File dir = new File("d:/imagecode");
		int w = 200, h = 80;
		String randomCode = generateRandomCode(4);
		File file = new File(dir, randomCode + ".jpg");
		outputImage(w, h, file, randomCode);
	}
}
